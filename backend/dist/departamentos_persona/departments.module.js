...
exports.DepartmentsModule_persona = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const departments_service_1 = require("./departments.service");
const departments_controller_1 = require("./departments.controller");
const department_entity_1 = require("./entities/department.entity");
let DepartmentsModule_persona = class DepartmentsModule_persona {
};
exports.DepartmentsModule_persona = DepartmentsModule_persona;
exports.DepartmentsModule_persona = DepartmentsModule_persona = __decorate([
    (0, common_1.Module)({
