...
exports.IdiomasModule = IdiomasModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([idioma_entity_1.Idioma])],
        controllers: [idiomas_controller_1.IdiomasController],
        providers: [idiomas_service_1.IdiomasService],
        exports: [idiomas_service_1.IdiomasService],
    })
], IdiomasModule);
